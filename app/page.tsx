        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
            ...
            <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">
              Why Choose <span className="text-blue-600">NexusHost</span>
            </h2>
            <p className="max-w-[700px] text-muted-foreground md:text-lg">
      ...
      <section className="py-20 md:py-28 bg-background">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
            ...
            <p className="max-w-[700px] text-muted-foreground md:text-lg">
              Don't just take our word for it. Here's what our customers have to say about NexusHost.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote:
                  "NexusHost has been a game-changer for our Minecraft server. The performance is incredible, and their support team is always there when we need them.",
                author: "Alex Johnson",
              ...
              {
                quote:
                  "I've tried many hosting providers, but NexusHost offers the best balance of performance, reliability, and price. Their VPS hosting is unmatched.",
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            >
              ...
              <p className="text-muted-foreground md:text-lg max-w-[600px]">
                Join thousands of satisfied customers who trust NexusHost for their hosting needs. Get started today
