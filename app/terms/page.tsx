      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="container px-4 md:px-6">
          ...
          >
            ...
            <p>
              Welcome to NexusHost. These Terms of Service ("Terms") govern your use of our website, products, and
            ...
            <p>
              NexusHost provides hosting services as described on our website. We reserve the right to modify, suspend,
            ...
            <p>
              In no event shall NexusHost, nor its directors, employees, partners, agents, suppliers, or affiliates, be
