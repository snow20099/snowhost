        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tighter md:text-5xl/tight">
              Contact <span className="text-blue-600">NexusHost</span>
            </h1>
            ...
            >
              ...
              <div className="mt-12 rounded-lg overflow-hidden h-[300px] relative">
                <iframe
                  ...
                  title="NexusHost Headquarters Location"
                ></iframe>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center text-center space-y-6 max-w-3xl mx-auto">
            ...
            <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed">
              Contact us today to learn how NexusHost can help you with your hosting needs. Our team is ready to assist
              you.
            </p>
