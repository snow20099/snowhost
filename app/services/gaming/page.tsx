        ...
        <div className="container px-4 md:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote:
                  "We've been hosting our Minecraft server with NexusHost for over a year now. The performance is incredible, and their support team is always there when we need them.",
                author: "Alex Johnson",
              ...
              {
                quote:
                  "Setting up our FiveM server was incredibly easy with NexusHost. The control panel is intuitive, and the performance has been rock solid for our roleplay community.",
                author: "Michael Chen",
